...
import sponsorBrands from "../../assets/sponsor-brands.svg";
import HomeSectionBlock from "./HomeSectionBlock";
import HomeSectionBlockReverse from "./HomeSectionBlockReverse";
import mostRequestedHabilities from "../../assets/most-requested-habilities.svg";
import connectWithWorld from "../../assets/connect-with-world.svg";
import practiceNewHabilities from "../../assets/practice-new-habilites.svg";
...
import tryIntellionIntroductionCourse from "../../assets/tryIntellionIntroductionCourse.svg";
import tryInternetIntroductionCourse from "../../assets/tryInternetIntroductionCourse.svg";
import tryCibersecurityIntroductionCourse from "../../assets/tryCibersecurityIntroductionCourse.svg";
          ...
          <div className="w-full flex flex-row items-center justify-between px-12">
            ...
            <Link to="">
              <button className="flex items-center justify-center gap-1 text-product-pink transition-colors hover:brightness-75 hover:underline">
                Ver todas os cursos <CaretRight size={20} />
              </button>
            </Link>
          </div>
